 ...
 * <p>
 * See http://developer.android.com/design/patterns/settings.html for design guidelines
 * and http://developer.android.com/guide/topics/ui/settings.html for more information on developing a Settings UI.
 */
public class SettingsActivity extends PreferenceActivity {
    ...
    protected void onDestroy() {
        ...
        if (!StreamService.isRunning() && !Settings.notificationsEnabled(getApplicationContext())) {
            stopService(new Intent(SettingsActivity.this, EdenService.class));
        }
    }
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference("auth_check"));
        bindPreferenceSummaryToValue(findPreference("auth_name"));
        bindPreferenceSummaryToValue(findPreference("notifications_check"));
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                //For checkbox preferences, change the checkbox value
